...
class MessageManager {
    ...
    async sendMessage(message) {
        ...
        try {
            ...
            document.getElementById('prison-btn').disabled = !window.gameStore.purchasedUpgradeIds.has("entrapment");
            document.getElementById('flashlight-btn').disabled = !window.gameStore.purchasedUpgradeIds.has("blinding_flash");
            document.getElementById('syringe-btn').disabled = !window.gameStore.purchasedUpgradeIds.has("hypnotic_serum");
            this.prefix = null;
            this.noLeave = false;
